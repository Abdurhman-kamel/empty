...
export default function Portfolio() {
    ...
    return (
        <section className='py-32 portfolio'>
            ...
            <div className="continer container w-10/12 mx-auto ">
                <div className="grid grid-cols-12 gap-11">
                    {portImg.map(img =>
                        <div className="cursor-pointer lg:col-span-4 md:col-span-6 sm:col-span-12 relative group">
                            <img className='rounded-lg w-full' src={img} alt="" />
                            <div onClick={function () { showedImg(img) }} className="imgHov absolute flex text-9xl rounded-lg group-hover:bg-[#1ABC9C]  justify-center items-center inset-0 transition-all duration-300">
